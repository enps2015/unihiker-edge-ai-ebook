...
Contribuicoes sao bem-vindas para melhoria editorial e tecnica.

1. Abra uma issue com a proposta.
2. Crie uma branch com nome claro.
3. Envie um pull request objetivo com arquivos impactados.

Diretrizes completas: [CONTRIBUTING.md](CONTRIBUTING.md)

## 📄 Licença

Este ebook está licenciado sob a licença
